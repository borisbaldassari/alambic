...
my %conf = (
    ...
    "provides_metrics" => {
        ...
        "MLS_DEV_AUTH_1M" => "MLS_SENDERS_30",
        ...
        "SCM_COMMITS_1M" => "SCM_COMMITS_30", 
        "SCM_COMMITTED_FILES_1M" => "SCM_COMMITTED_FILES_1M",
        "SCM_COMMITTERS_1M" => "SCM_AUTHORS_30", 
...
sub compute_data($) {
    ...
    $app->log->info("[Plugins::EclipseGrimoire] Starting compute data for [$project_id].");
