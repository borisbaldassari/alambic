...
file.metrics = paste("", project.id, "_metrics_gitlab_project.csv", sep="")
file.commits.hist = paste("", project.id, "_gitlab_git_commits_hist.csv", sep="")
file.commits = paste("", project.id, "_gitlab_git_commits.csv", sep="")
file.branches = paste("", project.id, "_gitlab_project_branches.csv", sep="")
file.mrs = paste("", project.id, "_gitlab_git_merge_requests.csv", sep="")
