...
* Total number of merge requests: ``r metrics[['SCM_PRS_OPENED']]``.
...
* ``r metrics[['SCM_PRS_OPENED_STALLED_1M']]`` merge requests are open and have had no update since more than one month.
