...
<span><span style="font-size:24pt">``r metrics[['PROJECT_FORKS']]``</span> Forks</span>
</div><div class="col-sm-3">
<span><span style="font-size:24pt">``r metrics[['PROJECT_STARS']]``</span> Stars</span>
</div><div class="col-sm-3">
<span><span style="font-size:24pt">``r metrics[['PROJECT_ISSUES_OPEN']]``</span> Issues open</span>
</div></div>
...
<span><span style="font-size:24pt">``r metrics[['PROJECT_COMMITS_1M']]``</span> Commits</span>
</div><div class="col-sm-3">
<span><span style="font-size:24pt">``r metrics[['PROJECT_COMMITTERS_1M']]``</span> Committers</span>
</div><div class="col-sm-3">
<span><span style="font-size:24pt">``r metrics[['PROJECT_AUTHORS_1M']]``</span> Authors</span>
</div></div>
...
<span><span style="font-size:24pt">``r metrics[['SCM_PRS_OPENED_1M']]``</span> MRs created last month</span>
</div><div class="col-sm-3">
<span><span style="font-size:24pt">``r metrics[['SCM_PRS_OPENED_STILL_1M']]``</span> MRs created within last month and still opened</span>
</div><div class="col-sm-3">
<span><span style="font-size:24pt">``r metrics[['SCM_PRS_OPENED_STALED_1M']]``</span> MRs staled (no update) for one month</span>
</div></div>
