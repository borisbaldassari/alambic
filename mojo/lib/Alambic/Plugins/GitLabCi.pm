...
#	"import_ci_pipelines.json" => "Original build file from GitLab server (JSON).",
	"ci_jobs.csv" => "List of builds (CSV).",
	"ci_jobs.json" => "List of builds (JSON).",
	"ci_pipelines.csv" => "List of pipelines (CSV).",
...
#	print "JSON " . Dumper($builds);
    ...
    $repofs->write_output( $project_id, "ci_pipelines.json", encode_json(\%pipelines) );
