...
sub run_post($$) {
    ...
    $repofs->write_output( 'EclipseReport', $project_id . "_main.csv", $csv_out );
    ...
    $repofs->write_output( 'EclipseReport', $project_id . "_info.csv", $csv_out );
    ...
    $repofs->write_output( 'EclipseReport', $project_id . "_metrics.csv", $csv_out );
    ...
    $repofs->write_output( 'EclipseReport', $project_id . "_recs.csv", $csv_out );
