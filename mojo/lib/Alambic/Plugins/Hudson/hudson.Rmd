...
<div class="col-md-6">
  <iframe src="/projects/`r project.id`/Hudson/hudson_pie.html" frameborder="0" style="width: 500px; height: 340px"></iframe>
</div>
</div>

## History 

<iframe src="/projects/`r project.id`/Hudson/hudson_hist.html" frameborder="0" style="width: 100%; height: 300px"></iframe>

## Failing Jobs

There are ``r metrics[['JOBS_RED']]`` failing jobs on the instance. 
