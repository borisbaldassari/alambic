...
ggsave(file=paste(project.id, "_jira_evol_authors.svg", sep=''), plot=gg, width=10, height=8)
ggsave(file=paste(project.id, "_jira_evol_authors.png", sep=''), plot=gg, width=10, height=8)

p <-dygraph(evol.xts[,c('authors')],
        main = paste('JIRA issues authors for ', project.id, sep=''),
