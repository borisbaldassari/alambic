...
</div><div class="col-sm-3">From <span style="font-size:24pt">``r first(issues.xts$creation_time)``</span>
</div><div class="col-sm-3">To <span style="font-size:24pt">``r last(issues.xts$last_change_time)``</span>
</div></div>
