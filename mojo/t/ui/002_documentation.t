...
# Check Metrics page.
$a = $t->get_ok('/documentation/metrics')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>Documentation</small> Metrics</h1>!i, 
		   'Documentation metrics page contains the correct title.')
    ->content_like(qr!<a href="metrics.html">All&nbsp; <span!i, 
