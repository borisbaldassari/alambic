...
$a = $t->get_ok('/')->status_is(200)
    ...
    ->content_like(qr!<blockquote>Default CLI Init description</blockquote>!i, 
		   'Main page contains the description blockquote.')
    ->content_like(qr!Projects</div>!i, 
		   'Main page contains projects panel.')
...
$a = $t->get_ok('/about.html')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>About</small> This web site</h1>!i, 
		   'About page contains the correct title.')
    ->content_like(qr!<p><b>Name</b> <br />\s*Default CLI init</p>!i, 
		   'About page contains correct instance name.')
    ->content_like(qr!<p><b>Description</b> <br />\s*Default CLI Init description</p>!i, 
		   'About page contains correct instance description.')
    ->content_like(qr!<h3 id="about">About Alambic</h3>!i, 
		   'About page contains the About Alambic section.')
    ->content_like(qr!<h3 id="mainfeatures">Main features</h3>!i, 
		   'About page contains the Main features section.')
    ->content_like(qr!<h3 id="yourproject">What about !i, 
		   'About page contains the About your project section.');

# Check Documentation main page.
$a = $t->get_ok('/documentation/main.html')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>Documentation</small> main page</h1>!i, 
    ...
    ->content_like(qr!<h3>Metrics, indicators, attributes, confidence</h3>!i, 
...
$a = $t->get_ok('/documentation/data.html')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>Documentation</small> Data</h1>!i, 
...
$a = $t->get_ok('/documentation/plugins.html')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>Documentation</small> Plugins</h1>!i, 
    ...
    ->content_like(qr!<a href="plugins\?type=global">Global!i, 
		   'Documentation plugins page contains global plugins section.')
...
$a = $t->get_ok('/documentation/plugins?type=pre')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>Documentation</small> Plugins</h1>!i, 
...
$a = $t->get_ok('/documentation/plugins?type=post')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>Documentation</small> Plugins</h1>!i, 
...
$a = $t->get_ok('/documentation/plugins?type=global')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>Documentation</small> Plugins</h1>!i, 
...
$a = $t->get_ok('/documentation/plugins?type=wiz')->status_is(200)
    ->content_like(qr!<h1 class="al-h1"><small>Documentation</small> Plugins</h1>!i, 
